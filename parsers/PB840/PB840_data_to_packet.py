import time
from PB840_fields import PB840_WEB_STRINGS, PB840_CHECKSUM, MODEMAP, REMOVE_FIELDS
from PB840_datagram import datagrams
...
def create_packet(data, debug=False):
    ...
    try:
        ...
        set_fspon(raw, res)
        set_ifalarm_active(raw, res, debug)

        return {"l": res, "n": "v", "v": str(int(time.time() * 1000))}, False
    except:
